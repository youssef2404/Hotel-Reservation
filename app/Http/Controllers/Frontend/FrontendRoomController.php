...
class FrontendRoomController extends Controller
{
    ...
    public function RoomDetailsPage($id)
    {
        ...
        $other = Room::where('id', '!=', $id)->orderBy('id', 'DESC')->limit(2)->get();
        return view('frontend.room.room_details',compact('roomdetails','multi_img','facility','other'));
    ...
    public function SearchRoomDetails(Request $request, $id)
    {
        ...
        $other = Room::where('id', '!=', $id)->orderBy('id', 'DESC')->limit(2)->get();
        $room_id = $id;
        return view('frontend.room.search_room_details',compact('roomdetails','multi_img',
            'facility','other','room_id'));
    }
