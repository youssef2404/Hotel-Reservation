                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" type="text" id="check_in"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input autocomplete="off" type="text" id="check_out"
                                                       required name="check_out"
                                                       class="form-control dt_picker"
                                                       value="{{ old('check_out') ? date('Y-m-d',strtotime(old('check_out'))) : ''}}">                                                <span class="input-group-addon"></span>
                                            </div>
                                            <i class='bx bxs-calendar'></i>
                                        </div>
                                    </div>
                    ...
                    <div class="room-details-article">
                        <div class="room-details-slider owl-carousel owl-theme">
                            @foreach($multi_img as $image)
                                <div class="room-details-item">
                                    <img src="{{asset('upload/roomimg/multi_img/'.$image->multi_image)}}" alt="Images">
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="room-details-content">
                            ...
                            <div class="side-bar-plan">
                                ...
                                <ul>
                                    @foreach($facility as $facl)
                                        <li><a href="#">{{$facl->facility_name}}</a></li>
                                    @endforeach
                                ...
                                <div class="col-lg-7 col-md-8 p-0">
                                    <div class="room-card-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class='bx bx-expand'></i> {{$item->size}}m2 / 376ft2</li>
                                        </ul>
