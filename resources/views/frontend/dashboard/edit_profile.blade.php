                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="address" name="address" value="{{$profileData->address}}" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" name="photo" id="image" value="{{$profileData->photo}}" class="form-control">
                                                        </div>
                                                    </div>
