                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <h6 class="my-1 text-info">{{\Carbon\Carbon::parse($editData->created_at)->format('d/m/Y')}}</h6>
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <h6 class="my-1 text-warning">@if($editData->payment_status == 1)
                                            <spin class="text-success">Complete</spin>
                                        @else
                                            <spin class="text-danger">Pending</spin>
                                        @endif</h6>
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <h6 class="my-1 text-warning">@if($editData->status == 1)
                                        <spin class="text-success">Active</spin>
                                    @else
                                        <spin class="text-danger">Pending</spin>
                                    @endif</h6>
                            </div>
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $assign_rooms = \App\Models\BookingRoomList::with('room_number')->where
                            ('booking_id',$editData->id)->get();
                        @endphp
                        ...
                        <table class="table table-bordered" style="margin-top: 20px;">
                            ...
                            <tr>
                                <td>{{$assign_room->room_number->room_number}}</td>
                                <td>
                        ...
                        <form action="{{route('update.booking.status',$editData->id)}}" method="post">
                            ...
                            <div class="row" style="margin-top: 40px;">
                                <div class="col-md-5">
                                    ...
                                    <select id="input7" class="form-select" name="payment_status">
                                ...
                                <div class="col-md-12" style="margin-top: 20px;"> <button type="submit" class="btn btn-primary">Update</button>
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">State <span class="badge bg-success rounded-pill">{{ $editData->state}}</span>
                            </li>
                            ...
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Address: <span class="badge bg-primary rounded-pill">{{ $editData->address}}</span>
                            </li>
                        </ul>
